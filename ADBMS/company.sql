...
-- use company;
-- create table regions(region_id varchar(20)PRIMARY KEY,region_name char(25));
-- create table countries(country_id VARCHAR(20) PRIMARY KEY,country_name varchar(25)NOT NULL, region_id varchar(20), FOREIGN KEY (region_id) REFERENCES regions (region_id));
-- create table locations(location_id int PRIMARY KEY,street_address varchar(50)NOT NULL,postal_code int,city char(40),state_province varchar(20),country_id varchar(25), FOREIGN KEY (country_id) REFERENCES countries (country_id));
-- create table departments(department_id int PRIMARY KEY,department_name varchar(30)NOT NULL,location_id int, FOREIGN KEY(location_id) REFERENCES locations (location_id));

-- drop table employees;
-- create table employees(employee_id int PRIMARY KEY,first_name varchar(20),last_name varchar(20),email varchar(30)NOT NULL,phone_number int,hire_date DATE,job_id INT,salary int,manager_id INT,department_id INT,FOREIGN KEY(job_id) REFERENCES jobs(job_id), FOREIGN KEY (manager_id) REFERENCES employees (employee_id),FOREIGN KEY(department_id) REFERENCES departments (department_id));
-- create table dependents(dependent_id int PRIMARY KEY,first_name varchar(15),last_name varchar(15),relationship char(30),employee_id int, FOREIGN KEY(employee_id) REFERENCES employees(employee_id));
...
alter table jobs modify column min_salary float;
alter table jobs modify column max_salary float;
